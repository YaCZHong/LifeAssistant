...
import com.czh.life_assistant.util.BezierUtil;
...
public class BubbleView extends View {
    ...
    private void initShader() {
        colors[0] = getResources().getColor(R.color.colorTextDark);
        colors[1] = getResources().getColor(R.color.colorTextDark2nd);
        positions[0] = 0;
        positions[1] = 1;
    }
