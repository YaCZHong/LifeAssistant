...
public class LunarCalendarUtils {
     ...
     * 用于保存中文的月份
     */
    public final static String CHINESE_NUMBER[] = {"正", "二", "三", "四", "五",
            "六", "七", "八", "九", "十", "冬", "腊"};
    /**
    ...
    public static String getLunarDayString(int solarYear, int solarMonth, int solarDay, int lunatYear, int lunatMonth, int lunatDay, boolean isLeap) {
        ...
        String oneToTen[] = {"一", "二", "三", "四", "五", "六", "七", "八", "九", "十"};
        ...
        if (lunatDay > 30) {
            ...
            relust = CHINESE_NUMBER[lunatMonth - 1] + "月" + "初十";
        } else if (lunatDay == 20) {
            relust = CHINESE_NUMBER[lunatMonth - 1] + "月" + "廿";
        } else if (lunatDay == 30) {
            relust = CHINESE_NUMBER[lunatMonth - 1] + "月" + "卅";
        } else
            relust = CHINESE_NUMBER[lunatMonth - 1] + "月" + chineseTen[lunatDay / 10] + oneToTen[n];
